...
if (isset ($_POST['id_lapangan']) && isset($_POST['Gambar']) && isset($_POST['nama_lapangan']) && isset($_POST['biaya_sewa']) && isset($_POST['Status']) && isset($_POST['Info']) ) {
  ...
  { echo "<script type='text/javascript'>alert('Edit Lapangan Berhasil Silahkan Cek informasi Lapangan !')</script>";
  }else
  ...
  <div class="card mt-5">
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
          <button type="submit" class="btn btn-info">Ubah Lapangan</button>
        </div>
      </form>
    </div>
  </div>
